...
describe('CarService Suite Tests', () => {
    ...
    before(() => {
        carService = new CarService({
            cars: carsDatabase // não há mais necessidade, já que foi mockado
        })
    })
    ...
    it('given a carCategory it should return an avaliable car', async () => {
        ...
        const carCategory = Object.create(mocks.validCarCategory) // Uso do object create é parão não "sujar" a instância do mock
    ...
    it('given a carCategory, customer and numberOfDays it should calculate final amount in real', () => {
        const customer = Object.create(mocks.validCustumer)
        customer.age = 50
        ...
        // age: 50 - 1.3 tax - carCategory 37.6
